...
export const setModuleSettings: SetModuleSettings<ModuleSettings> = newSettings => { moduleSettings = newSettings; };
...
export const qm: Command = async message => {
	...
	return {
		console: chalk`{white${question}'s} {yellow=>} {brightcyan ${answer}}`,
